...
model.add( rule : (retweets(U1, U2, I) & friendTweetTopic(U1, I, '0') & affects(U2)) >> ~recovers(U2), 
   squared:true, weight :1)
model.add( rule : (replies(U1, U2, I) & friendTweetTopic(U1, I, '0') & affects(U2)) >> ~recovers(U2), 
   squared:true, weight :1)

model.add( rule : (retweets(U1, U2, I) & friendTweetTopic(U1, I, '1') & affects(U2)) >> recovers(U2), 
   squared:true, weight :1)
model.add( rule : (replies(U1, U2, I) & friendTweetTopic(U1, I, '1') & affects(U2)) >> recovers(U2), 
   squared:true, weight :1)
...
//	model.add( rule : (affect(U1) & replies(U1, U2, I) & usesAlcoholWord(U2, aw)) >> ~recovers(U1), squared:true,
//		weight : 1)
//	model.add( rule : (affect(U1) & retweets(U1, U2, I) & usesAlcoholWord(U2, aw)) >> ~recovers(U1), squared:true,
//		weight : 1)
}
...
//	model.add( rule : (affect(U1) & retweets(U1, U2, I) & usesSoberWord(U2, sw)) >> recovers(U1), squared:true,
// 		weight : 1)
//	model.add( rule : (affect(U1) & replies(U1, U2, I) & usesSoberWord(U2, sw)) >> recovers(U1), squared:true,
//		weight : 1)
}
