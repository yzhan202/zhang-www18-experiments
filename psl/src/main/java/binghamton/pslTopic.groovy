...
model.add( rule : (retweets(U1, U2, I) & friendTweetTopic(U1, I, '0') & attendsAA(U2)) >> ~recovers(U2), 
   squared:true, weight :1)
model.add( rule : (replies(U1, U2, I) & friendTweetTopic(U1, I, '0') & attendsAA(U2)) >> ~recovers(U2), 
   squared:true, weight :1)

model.add( rule : (retweets(U1, U2, I) & friendTweetTopic(U1, I, '1') & attendsAA(U2)) >> recovers(U2), 
   squared:true, weight :1)
model.add( rule : (replies(U1, U2, I) & friendTweetTopic(U1, I, '1') & attendsAA(U2)) >> recovers(U2), 
   squared:true, weight :1)
...
for(String sw : ['#recovery', 'sober', 'sobriety', 'recovery', '#sobriety']){
	...
	model.add( rule : (replies(U2, U1, I1) & retweets(U1, U2, I2) & containsSoberWord(U1, I2, sw) & attendsAA(U2)) >> recovers(U2), squared:true,
		weight : initialWeight)
	model.add( rule : (replies(U2, U1, I1) & replies(U1, U2, I2) & containsSoberWord(U1, I2, sw) & attendsAA(U2)) >> recovers(U2), squared:true,
		weight : initialWeight)
	model.add( rule : (retweets(U2, U1, I1) & retweets(U1, U2, I2) & containsSoberWord(U1, I2, sw) & attendsAA(U2)) >> recovers(U2), squared:true,
		weight : initialWeight)
	model.add( rule : (retweets(U2, U1, I1) & replies(U1, U2, I2) & containsSoberWord(U1, I2, sw) & attendsAA(U2)) >> recovers(U2), squared:true,
		weight : initialWeight)
