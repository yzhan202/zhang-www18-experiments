...
model.add( rule: (localRecovers(U)) >> recovers(U), squared: true, weight : 1)
model.add( rule : (~(localRecovers(U))) >> ~(recovers(U)), squared:true, weight : 1)

log.info("Defining similarity collective rules..");
model.add( rule : (similar(U1, U2) & recovers(U2)) >> recovers(U1), squared:true, weight : 1)
model.add( rule : (similar(U1, U2) & recovers(U1)) >> recovers(U2), squared:true, weight : 1)
model.add( rule : (similar(U1, U2) & ~recovers(U2)) >> ~recovers(U1), squared:true, weight : 1)
model.add( rule : (similar(U1, U2) & ~recovers(U1)) >> ~recovers(U2), squared:true, weight : 1)

model.add( rule: (topics(U, '0')) >> ~recovers(U), squared: true, weight : 1)
model.add( rule: (topics(U, '1')) >> recovers(U), squared: true, weight : 1)

//model.add( rule : (retweets(U1, U2, I) & friendTweetTopic(U1, I, '0') & attendsAA(U2) & pos_sentiment(U1, I)) >> ~recovers(U2), 
//   squared:true, weight :0.4)
//model.add( rule : (replies(U1, U2, I) & friendTweetTopic(U1, I, '0') & attendsAA(U2) & pos_sentiment(U1, I)) >> ~recovers(U2), 
//   squared:true, weight :0.4)

//model.add( rule : (retweets(U1, U2, I) & friendTweetTopic(U1, I, '1') & attendsAA(U2) & pos_sentiment(U1, I)) >> recovers(U2), 
//   squared:true, weight :0.4)
//model.add( rule : (replies(U1, U2, I) & friendTweetTopic(U1, I, '1') & attendsAA(U2) & pos_sentiment(U1, I)) >> recovers(U2), 
//   squared:true, weight :0.4)
...
for(String aw : topAlcoholWords){
	model.add( rule : (containsAlcoholWord(U, I, aw) & attendsAA(U)) >> ~recovers(U), squared:true,
		weight : initialWeight)	
	model.add( rule : (~usesAlcoholWord(U, aw) & attendsAA(U)) >> recovers(U), squared:true,
		weight : initialWeight)
...
//	model.add( rule : (affect(U1) & friends(U1, U2) & usesAlcoholWord(U2, aw)) >> ~recovers(U1), squared:true,
//		weight : 0.4)
}

for(String sw : ['#recovery', 'sober', 'sobriety', 'recovery', '#sobriety']){
	model.add( rule : (containsSoberWord(U, I, sw) & attendsAA(U)) >> recovers(U), squared:true,
		weight : initialWeight)
	model.add( rule : (~usesSoberWord(U, sw) & attendsAA(U)) >> ~recovers(U), squared:true,
		weight : initialWeight)
...
//	model.add( rule : (affect(U1) & friends(U1, U2) & usesSoberWord(U2, sw)) >> recovers(U1), squared:true,
//		weight : 0.4)
