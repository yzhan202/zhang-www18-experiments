...
model.add( rule: (localRecovers(U)) >> recovers(U), squared: true, weight : initialWeight)
model.add( rule : (~(localRecovers(U))) >> ~(recovers(U)), squared:true, weight : initialWeight)

model.add( rule: (topics(U, '0')) >> ~recovers(U), squared: true, weight : initialWeight)
model.add( rule: (topics(U, '1')) >> recovers(U), squared: true, weight : initialWeight)
