...
friendTweet_dir = join(dataset_dir, 'friendjusttweets')
testfriendTweet_dir = join(dataset_dir, 'chiaaFriends/friendtweetsExtracted')
newfriendTweet_dir = join(new_dataset_dir, 'friendTweets')
lastfriendTweet_dir = '/home/yue/Public/Python/twitter_work/newExtractTweets/dataset/friendTweets'
...
def main():
    ...
    retweet_output = './features/userRetweets.txt'
    ...
    reply_output = './features/userReplies.txt'
    ...
    containAlc_output = './features/userContainsAlcoholWord.txt'
    ...
    useAlc_output = './features/userUsesAlcoholWord.txt'
    ...
    containSober_output = './features/userContainsSoberWord.txt'
    ...
    useSober_output = './features/userUsesSoberWord.txt'
